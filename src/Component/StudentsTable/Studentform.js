    ...
    return (
        <div className='m-2'>
            <form onSubmit={Mysubmit} className='w-50 mx-auto p-4 rounded-3' style={{ backgroundColor: "rgb(206 193 193 / 41%)" }}>
                ...
                <label>Male</label>
                <input className='dd'type="radio" name="gender" value='Male' onClick={myHandler} />
                <label>Female</label>
            ...
            <StudentTable mydata={data} remove={Mydelete} edit={Myedit} find={search} />
        </div>
    );
}
